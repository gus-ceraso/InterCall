...
export { GENERATED_TYPESCRIPT_MARKER, decodeGeneratedInterface, hasGeneratedTypeScriptMarker, readGeneratedMetadata, semanticDocumentation, validateMetadataRows } from "./metadata-reader.js";
