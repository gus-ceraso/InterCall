...
declare module "@cerasos/intercall/generated" {
  ...
  export function call(connection: import("@cerasos/intercall").Connection, binding: unknown, key: bigint, encode: () => Uint8Array, decode: (key: bigint, payload: Uint8Array) => void | { readonly kind: "remote-exception"; readonly error: Error }, options?: import("@cerasos/intercall").CallOptions): Promise<void>;
