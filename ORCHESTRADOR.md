...
- Never rely on an inherited or shared current directory. Give every Worker and
  ...
  read-only.
- The module is `github.com/cerasos/intercall` on Go 1.26.5. Always specify
...
MODULE/TOOLCHAIN: github.com/cerasos/intercall; Go 1.26.5; use only /usr/local/go/bin/go.
