...
- [x] [RM-02 — Make write admission and terminal teardown live](#rm-02--make-write-admission-and-terminal-teardown-live) — `c5bce3da0df68c0ada83bd203091f669cda9c31c`
- [x] [RM-03 — Order incoming request admission and ID reuse](#rm-03--order-incoming-request-admission-and-id-reuse) — `1a3a06db593a43d2a28e7d9b2a142a63463f51df`
...
- [x] [RM-05 — Correct semantic-document line and anchor handling](#rm-05--correct-semantic-document-line-and-anchor-handling) — `8b2c3e70ffa571c5f04b80bcac8fac982380eb9d`
...
- [x] [RM-13 — Type-check generated bindings before mutation](#rm-13--type-check-generated-bindings-before-mutation) — `0f9c96e85609f9f08bb7833a8b8d08ea2210f2a1`
- [x] [RM-14 — Require canonical owned interface bodies](#rm-14--require-canonical-owned-interface-bodies) — `3e75c72723ee12d5377b2884fda17936f1e3d507`
- [x] [RM-15 — Reconcile documentation, fixtures, and final remediation](#rm-15--reconcile-documentation-fixtures-and-final-remediation) — `404282eb8aca2761b3e88b07d603e6f8cfb56220`
